...
import { TrendingUp, Award, Target, CheckCircle, XCircle, BarChart3, Flame } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-white/5 rounded-[32px] p-6 border border-gray-200 dark:border-white/10 shadow-sm mb-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-sm font-black uppercase tracking-widest text-gray-900 dark:text-white">Evolução de Pontos</h3>
          </div>
          {chartData.length > 0 ? (
